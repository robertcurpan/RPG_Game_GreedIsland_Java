...
public class Map1Scene6 extends BaseAbstractMap
{
    ...
    {
        Scanner finFront = new Scanner(new FileReader("res/maps/map1scene6frontlayer.txt"));
        Scanner finBack = new Scanner(new FileReader("res/maps/map1scene6backlayer.txt"));
