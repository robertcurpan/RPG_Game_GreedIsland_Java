...
public class Map2Scene4 extends BaseAbstractMap
{
    ...
    {
        Scanner finFront = new Scanner(new FileReader("res/maps/map2scene4frontlayer.txt"));
        Scanner finBack = new Scanner(new FileReader("res/maps/map2scene4backlayer.txt"));
