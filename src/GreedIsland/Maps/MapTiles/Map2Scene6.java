...
public class Map2Scene6 extends BaseAbstractMap
{
    ...
    {
        Scanner finFront = new Scanner(new FileReader("res/maps/map2scene6frontlayer.txt"));
        Scanner finBack = new Scanner(new FileReader("res/maps/map2scene6backlayer.txt"));
