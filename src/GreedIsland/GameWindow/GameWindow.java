package GreedIsland.GameWindow;
...
public class GameWindow {
 ...
 // ####################################################################################### //
    ...
    public GameWindow(String title, int width, int height){
        ...
        wndFrame    = null;     // fereastra nu este construita inca
    }
    ...
    public void BuildGameWindow(){
        ...
        if(wndFrame != null){
            ...
            /// Aloca memorie pt obiectul de tip fereastra si seteaza denumirea
        ...
        wndFrame.setVisible(true);
            ...
            /// Creeaza obiectul de tip canvas (panza) pe care se poate desena.
        canvas = new Canvas();
            ...
            /// Urmatorul apel de functie seteaza dimensiunea "preferata"/implicita
    ...
    /*! \fn public int GetWndFrame()
        \brief Returneaza referinta catre frame-ul (fereastra principala) a jocului
     */
